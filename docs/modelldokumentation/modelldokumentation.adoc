...
* https://ch-sz-geo.github.io/A000_template/[Übersicht AXXX Dokumentation] +
* https://ch-sz-geo.github.io/A000_template/docs/modelldokumentation.pdf[Dokumentation als Pdf] +
